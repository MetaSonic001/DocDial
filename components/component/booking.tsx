        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('9:00 AM')}>
                9:00 AM
              </Button>
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('10:00 AM')}>
                10:00 AM
              </Button>
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('11:00 AM')}>
                11:00 AM
              </Button>
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('1:00 PM')}>
                1:00 PM
              </Button>
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('2:00 PM')}>
                2:00 PM
              </Button>
              <Button size="sm" variant="outline" onClick={() => handleTimeChange('3:00 PM')}>
                3:00 PM
              </Button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <Button
                className="w-full"
                onClick={() => {
                  // Perform actions with selectedDate and selectedTime
                  console.log('Appointment confirmed for:', selectedDate, selectedTime);
                }}
              >
                Confirm Appointment
              </Button>

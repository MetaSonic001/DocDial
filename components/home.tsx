...
import MedicalServicesCards from "./ServicesCard";
  ...
  const Card = ({
    ...
    return (
      <motion.div
        ...
        className={`w-[220px] h-[321px] bg-white rounded-tr-[10px] overflow-hidden flex flex-col justify-center items-center relative shadow-md transition-all duration-300 ease-out ${shadowColor}`}
      >
        <div
          className={`w-[118px] h-[118px] rounded-full ${bgColor} absolute top-[70px] left-[50px] z-0 transition-transform duration-300 ease-out group-hover:scale-[4]`}
        />
        <div
          className={`w-[131px] h-[131px] rounded-full bg-white border-2 ${bgColor} flex justify-center items-center relative z-10 transition-all duration-300 ease-out group-hover:bg-opacity-0 group-hover:border-opacity-20`}
        >
          <div
            className={`w-[118px] h-[118px] absolute ${bgColor} rounded-full top-[7px] left-[7px] transition-opacity duration-300 ease-out group-hover:opacity-0`}
          />
          <Icon className="w-16 h-16 text-white z-20" />
        </div>
        <p className="text-[17px] text-[#4c5656] mt-[30px] z-20 transition-colors duration-300 ease-out group-hover:text-white">
          {title}
        </p>
      </motion.div>
    );
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                possible care and support. From diagnosis to treatment, we are
                here to help you with whatever you may need.
              </p>
              <motion.button
              ...
              <div className="mt-12 grid grid-cols-3 gap-8">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`w-16 h-1 ${stat.color} rounded-full my-2`}
                    ></div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Read about the experiences of our satisfied patients and their
